...
//   const actionButtons = document.getElementById("action-buttons-column");

//   if (toggleButton && closeButton && actionButtons) {
...
//   if (actionButtons && toggleButton) {
//     const isHidden = actionButtons.classList.contains("hidden");
//     if (isHidden) {
//       actionButtons.classList.remove("hidden");
//       toggleButton.classList.add("hidden");
//     } else {
...
toggleButton.addEventListener("click", () => {
  actionButtons.classList.remove("hidden");  // Show buttons
  toggleButton.classList.add("hidden");      // Hide "Actions" button
});

closeButton.addEventListener("click", () => {
  actionButtons.classList.add("hidden");     // Hide buttons
  toggleButton.classList.remove("hidden");   // Show "Actions" button again
});
