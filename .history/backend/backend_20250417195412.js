...
function touchPet(personality) {
    switch (personality.clingy) {
        case true:
            ...
            console.log("You pet your pet and they love it!");
            break;
        case false:
            loseStatus("happiness");
            console.log("Your pet seems indifferent to your touch.");
            break;
        default:
...
function feedPet(personality) {
    switch (personality.foodLover) {
        case true:
            gainStatus("hunger");
            console.log("Your pet devours the food happily!");
            break;
        case false:
            loseStatus("hunger");
            console.log("Your pet snubs the food and walks away.");
            break;
        default:
            console.log("Invalid personality trait");
    }
...
function bathePet(personality) {
    switch (personality.clean) {
        case true:
            gainStatus("hygiene");
            console.log("Your pet enjoys the bath and comes out clean!");
            break;
        case false:
            loseStatus("hygiene");
            console.log("Your pet resists the bath and gets dirty again.");
            break;
        default:
            console.log("Invalid personality trait");
    }
...
function bedtime(personality) {
    switch (personality.active) {
        case true:
            gainStatus("energy");
            console.log("Your pet is too energetic to sleep right now.");
            break;
        case false:
            loseStatus("energy");
            console.log("Your pet is sleepy and ready for bed.");
            break;
        default:
            console.log("Invalid personality trait");
    }
